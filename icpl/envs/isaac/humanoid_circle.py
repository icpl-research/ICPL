...
class HumanoidCircle(VecTask):
    ...
    def compute_observations(self):
        ...
        self.obs_buf[:], self.torso_position[:], self.prev_torso_position[:], self.velocity_world[:], self.angular_velocity_world[:], self.velocity_local[:], self.angular_velocity_local[:], self.up_vec[:], self.heading_vec[:] = compute_humanoid_circle_observations(
...
@torch.jit.script
def compute_humanoid_circle_observations(obs_buf, root_states, torso_position, inv_start_rot, dof_pos, dof_vel,
    ...
    return obs, torso_position, prev_torso_position, velocity_world, angular_velocity_world, velocity_local, angular_velocity_local, up_vec, heading_vec
